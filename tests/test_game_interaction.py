...
def test_room_objects():
    ...
    chest = RoomObject("chest", "A locked wooden chest with gold trim.", tags=["container", "locked"])
    ...
    def open_with_key(user, item=None, room=None):
        ...
        if "locked" in chest.tags:
            ...
            chest.change_description("An unlocked wooden chest with gold trim. It's open and ready for looting.")
            if room:
    ...
    torch_holder = RoomObject("torch holder", "An empty metal bracket on the wall.", tags=["fixture"])
    ...
    def place_torch(user, item=None, room=None):
        ...
        torch_holder.change_description("A metal bracket holding a lit torch, illuminating the area.")
        if room:
            room.change_description(room.base_description + " The room is now well lit.")
    ...
    plant = RoomObject("dried plant", "A withered plant that looks very dry.", tags=["flammable"])
